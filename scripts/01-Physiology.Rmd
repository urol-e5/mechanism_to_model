...
Read in data 
```{r}
afdw <- read.csv("../data/01-Physiology/AFDW.csv")
chlo_sym <- read.csv("../data/01-Physiology/chl_zoox_sheet.csv")
photo <- read.csv("../data/01-Physiology/Pmax_data.csv") %>%
...
# Save as csv 
write.csv(data_pc, "../data/01-Physiology/phys_data_pc.csv")
```
